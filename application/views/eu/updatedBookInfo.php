    ...
    <div class="">
        ...
        <div class="col-md-8">
         <div class="alert alert-info">
          ...
          <form method="post" action="<?php echo base_url();?>book_controller/update_book_data.html">
             
              <div class="form-group">
              <label for="exampleInputText">Student Name</label>
              <input type="hidden" class="form-control" name='book_id'id="exampleInputText" value="<?php echo $edit_book->book_id;?>">
              <input type="text" class="form-control" name='book_name'id="exampleInputText" value="<?php echo $edit_book->book_name;?>">
              </div>
             <div class="form-group">
             ...
             <select name="dep_name"  class="form-control"id="exampleInputText">
                 ...
                 if($edit_book->dep_name==$depData->dep_id){?>
             ...
             <div class="form-group">
             <label for="exampleInputText">Author Name</label>
             <input type="text" class="form-control" name='author_name' id="exampleInputText" value="<?php echo $edit_book->author_name;?>">
            </div>
           
              <button type="submit" class="btn btn-success btn-lg btn-block">Update book </button>
           </form> 
