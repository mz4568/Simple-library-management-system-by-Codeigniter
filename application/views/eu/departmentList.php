    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
            ...
            <table  class="table table-hover">
                    ...
                    <?php
                    $i=0;
                    foreach($dep_list_info as $value){ 
                    $i++;   
                        ?>
                    <tbody>
                     <td> <?php echo $i;?> </td>   
                     <td> <?php echo $value->department_name;?> </td>
                    <td> <a href="<?php echo base_url();?>department_controller/edit_dep_info/<?php echo $value->dep_id;?>"> Edit </a>||
                    <a href="<?php echo base_url();?>department_controller/delete_department_info/<?php echo $value->dep_id;?>"> Delete </a> </td>
                     </tbody>
                    <?php } ?>      
             </table>
         </div>
