    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
         <div class="alert alert-info">
          ...
          <form method="post" action="<?php echo base_url();?>eu_controller/insert_student_information.html">
             <div class="form-group">
             <label for="exampleInputText">Student ID</label>
             <input type="text" class="form-control" name='student_id'id="exampleInputText" placeholder="Student ID">
            </div>
              <div class="form-group">
             <label for="exampleInputText">Student Name</label>
             <input type="text" class="form-control" name='student_name'id="exampleInputText" placeholder="Student Name">
            </div>
             <div class="form-group">
