    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
            ...
            <table  class="table table-hover">
                    ...
                    <?php
                    $i=0;
                    foreach($student_list_info as $value){ 
                    $i++;   
                        ?>
                    <tbody>
                     <td> <?php echo $i;?> </td>   
                    ...
                    <td> <a href="<?php echo base_url();?>eu_controller/edit_student_info/<?php echo $value->id;?>"> Edit </a>||
                    <a href="<?php echo base_url();?>eu_controller/delete_student_info/<?php echo $value->id;?>"> Delete </a> </td>
                     </tbody>
                    <?php } ?>      
             </table>
         </div>
