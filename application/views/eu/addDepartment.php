  ...
  <head>
   ...
   <body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
         <div class="alert alert-info">
             <h4 style="text-align: center"> Add Department </h4>
             
         </div>
         
          <form method="post" action="<?php echo base_url();?>department_controller/insert_dep_information.html">
             <div class="form-group">
             <label for="exampleInputText">Department Name</label>
             <input type="text" class="form-control" name='department_name'id="exampleInputText" placeholder="Department Name">
            </div>
             
              <button type="submit" class="btn btn-success btn-lg btn-block">Add Department</button>
           </form> 
