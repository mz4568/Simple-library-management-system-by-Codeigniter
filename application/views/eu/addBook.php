    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
         <div class="alert alert-info">
          ...
          <form method="post" action="<?php echo base_url();?>book_controller/insert_book_information.html">
             
              <div class="form-group">
             <label for="exampleInputText">Book Name</label>
             <input type="text" class="form-control" name='book_name'id="exampleInputText" placeholder="Book Name">
            </div>
             <div class="form-group">
             ...
             <input type="text" class="form-control" name='author_name' id="exampleInputText" placeholder="Author Name">
            </div>
