    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
         <div class="alert alert-info">
          ...
          <form method="post" action="<?php echo base_url();?>book_controller/insert_author_information.html">
             ...
             <input type="text" class="form-control" name='author_name'id="exampleInputText" placeholder="Author Name">
              ...
              <button type="submit" class="btn btn-success btn-lg btn-block">Add Author</button>
           </form> 
