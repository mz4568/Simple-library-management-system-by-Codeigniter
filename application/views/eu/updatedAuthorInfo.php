  ...
  <head>
   ...
   <body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
         <div class="alert alert-info">
             <h4 style="text-align: center"> Update Author </h4>
             
         </div>
         
           <form method="post" action="<?php echo base_url();?>book_controller/Update_author_information.html">
             <div class="form-group">
             <label for="exampleInputText">Author Name</label>
             <input type="hidden" class="form-control" name='author_id'id="exampleInputText" value="<?php echo $edit_author->author_id;?>">
             <input type="text" class="form-control" name='author_name'id="exampleInputText" value="<?php echo $edit_author->author_name;?>">
            </div>
             
              <button type="submit" class="btn btn-success btn-lg btn-block">Update Author</button>
           </form> 
