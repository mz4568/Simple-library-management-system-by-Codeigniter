    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
            ...
            <table  class="table table-hover">
                    ...
                    <?php
                    $i=0;
                    foreach($book_list_info as $value){ 
                    $i++;    
                        ?>
                    <tbody>
                     <td> <?php echo $i;?> </td>
                    ...
                    <td> <a href="<?php echo base_url();?>book_controller/edit_book_info/<?php echo $value->book_id;?>"> Edit </a>||
                    <a href="<?php echo base_url();?>book_controller/delete_book_info/<?php echo $value->book_id;?>"> Delete </a> </td>
                     </tbody>
                    <?php } ?>      
             </table>
         </div>
